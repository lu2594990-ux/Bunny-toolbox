jQuery(() => {
    ...
    var allEvents = ["click", "touchstart", "touchmove", "touchend", "mousedown", "mouseup", "pointerdown", "pointerup"];
    ...
    styleEl.textContent =
        ...
        ".bny-toast{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);background:rgba(0,0,0,0.75);color:white;padding:16px 28px;border-radius:16px;font-size:16px;pointer-events:none;opacity:0;transition:opacity 0.3s ease;z-index:99999;font-family:sans-serif;}" +
        ".bny-toast.show{opacity:1;}";
