jQuery(() => {
    ...
    getContainer().append(
        ...
        '<div class="inline-drawer-content">' +
            ...
            '<textarea id="bny-style-prompt" rows="3" style="width:100%;padding:5px 8px;border-radius:8px;border:1px solid #ddd;font-size:12px;resize:vertical;font-family:inherit;"></textarea>' +'<button id="bny-save" style="margin-top:6px;padding:6px 20px;border-radius:8px;border:none;background:linear-gradient(135deg,#ff6b9d,#c44569);color:white;font-size:12px;cursor:pointer;width:100%;">💾 保存所有设置</button>' +
    ...
    function doPolish(mode) {
        ...
        callApi(prompt, gContent).then(function (r) {
            ...
            stEl.textContent = "❌ " + label + "失败";
            stEl.className = "st err";
            edEl.textContent = e.message;
            edEl.style.display = "block";setAB(false);
        });
    }
