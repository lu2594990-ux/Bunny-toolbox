jQuery(() => {
    ...
    function getActiveOrder() {
        try {
            ...
            for (var i = 0; i < po.length; i++) {
                if (po[i].character_id === charId) return po[i].order;
            }
            for (var i = 0; i < po.length; i++) {
    ...
    panel.addEventListener("touchend", function (e) { e.stopPropagation(); });panel.addEventListener("click", function (e) { e.stopPropagation(); });panel.addEventListener("mousedown", function (e) { e.stopPropagation(); });
